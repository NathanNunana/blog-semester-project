      ...
      <div class="col-md-12 col-lg-10">
        <div class="post-entry text-center">
          ...
          <div class="post-meta align-items-center text-center">
            ...
            <span class="d-inline-block mt-1">By Nathan Kulewoshie</span>
        ...
        <div class="post-content-body">
          ...
          <div class="row mb-5 mt-5">
            <div class="col-md-12 mb-4">
              <img src="uploads/img_1.jpg" alt="Image placeholder" class="img-fluid rounded">
            </div>
            <div class="col-md-6 mb-4">
              <img src="uploads/img_2.jpg" alt="Image placeholder" class="img-fluid rounded">
            </div>
            <div class="col-md-6 mb-4">
              <img src="uploads/img_3.jpg" alt="Image placeholder" class="img-fluid rounded">
            </div>
          </div>
        ...
        <div class="sidebar-box">
          ...
          <div class="post-entry-sidebar">
            <ul>
              <li>
                <a href="">
                  <img src="uploads/img_1.jpg" alt="Image placeholder" class="mr-4">
                  <div class="text">
                    <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                    <div class="post-meta">
                      <span class="mr-2">March 15, 2022 </span>
                    </div>
                  </div>
                </a>
              </li>
  ...
  <div class="container">
    ...
    <div class="row align-items-stretch retro-layout">
      ...
      <div class="col-md-5 order-md-2">
        <a href="single.php" class="hentry img-1 h-100 gradient" style="background-image: url('uploads/img_4.jpg');">
      ...
      <div class="col-md-7">
        ...
        <a href="single.html" class="hentry img-2 v-height mb30 gradient" style="background-image: url('uploads/img_1.jpg');">
        ...
        <div class="two-col d-block d-md-flex">
          <a href="single.php" class="hentry v-height img-2 gradient" style="background-image: url('uploads/img_2.jpg');">
          ...
          <a href="single.php" class="hentry v-height img-2 ml-auto gradient" style="background-image: url('uploads/img_3.jpg');">
